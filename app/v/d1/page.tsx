// Homepage v2 — Option D1: Editorial + Playful
// D with squiggly underlines on section headings, TangerineDoodle in HM banner,
// and a squiggle below the hero tagline.
    ...
    <main>
      ...
      <section className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-end pb-16 md:pb-24 px-6 text-center">
          ...
          {/* Tagline — with squiggle below */}
          <div className="mt-3 md:mt-4 flex flex-col items-center">
            <p className="text-[13px] md:text-[15px] uppercase tracking-[0.2em] text-white/70">
              Craft supplies for a colorful life
            </p>
            <SquigglyUnderline className="w-32 md:w-48 mt-1.5 opacity-50" color="#FFFFFF" />
          </div>
      ...
      >
        <p className="text-[13px] md:text-[15px] uppercase tracking-[0.15em] font-semibold text-white inline-flex items-center gap-2 justify-center">
          <TangerineDoodle className="w-5 h-5 opacity-80" />
      ...
      <section className="px-4 md:px-10 pt-8 md:pt-12 pb-0">
        ...
        >
          <span className="relative inline-block">
            Shop by Category
            <SquigglyUnderline className="absolute -bottom-2 left-0 w-full" color="var(--color-orange)" />
          </span>
        </h2>
      ...
      <section className="pt-8 md:pt-10 pb-0">
        ...
        >
          <span className="relative inline-block">
            New Arrivals
            <SquigglyUnderline className="absolute -bottom-2 left-0 w-full" color="var(--color-teal)" />
          </span>
        </h2>

// Homepage v2 — Option D3: Editorial + Color
// D with teal categories background, split About/Newsletter (orange right panel),
// orange accent strip before spotlight, teal Instagram header bar,
// and teal border accents on the HM banner.
  ...
  return (
    <main>
      ...
      <section className="px-4 md:px-10 pt-8 md:pt-12 pb-8 md:pb-10" style={{ background: "var(--color-teal)" }}>
        <h2
          className="text-[15px] md:text-[18px] uppercase tracking-[0.12em] font-semibold text-center mb-5 md:mb-6 text-white"
        >
          Shop by Category
        </h2>
      ...
      <section className="py-10 md:py-14">
        <div className="max-w-5xl mx-auto md:flex md:items-stretch md:gap-0">
          ...
          {/* Newsletter — right, orange background */}
          <div
